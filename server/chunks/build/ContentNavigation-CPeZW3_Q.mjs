...
import { u as useContentDisabled, q as queryContent, w as withContentBase, e as encodeQueryParams, a as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-CgI7t6Iq.mjs';
import { u as useContentPreview } from './preview-K77awpMj.mjs';
import { W as useState, L as useRuntimeConfig, _ as __nuxt_component_0$1 } from './server.mjs';
import 'unified';
import 'remark-parse';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-B7PiAqPb.mjs').then((m) => m.generateNavigation);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+content@2.13.4_nuxt@3.14.1592_rollup@4.27.3_vue@3.5.13/node_modules/@nuxt/content/dist/runtime/components/ContentNavigation.vue");
