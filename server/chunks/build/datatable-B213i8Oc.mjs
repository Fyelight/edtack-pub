import { B as BaseStyle, G as FilterMatchMode, J as script$l$1, K as script$k$1, d as script$M, s as script$H, k as script$T, j as script$U, R as Ripple, l as script$9$2, m as script$q$1, n as script$G, o as script$D, p as script$B, q as script$e$1, O as OverlayEventBus, t as getVNodeProp, v as script$S, w as script$x, x as script$F, U as UniqueComponentId, y as _default, C as ConnectedOverlayScrollHandler, z as FilterOperator, A as script$L, D as script$I, E as FilterService, H as script$K, I as script$R } from './server.mjs';
import { setAttribute, getFirstFocusableElement, invokeElementMethod, getAttribute, getNextElementSibling, getOuterWidth, getPreviousElementSibling, getOuterHeight, focus, addStyle, absolutePosition, isTouchDevice, getIndex, isClickable, clearSelection, findSingle, find, exportCSV, getOffset, getHiddenElementOuterWidth, getHiddenElementOuterHeight, removeClass, addClass } from '@primeuix/utils/dom';
...
import { defineComponent, mergeProps, unref, isRef, withCtx, createVNode, createTextVNode, toDisplayString, useSSRContext, ref, openBlock, createElementBlock, createElementVNode, resolveDirective, withDirectives, createBlock, resolveDynamicComponent, resolveComponent, normalizeClass, createSlots, Fragment, renderList, normalizeProps, renderSlot, createCommentVNode, withModifiers, Transition, withKeys } from 'vue';
...
var _hoisted_1$5 = ["aria-label", "aria-current", "onClick", "data-p-active"];
function render$3$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("span", mergeProps({
    ...
    }), [createTextVNode(toDisplayString(pageLink), 1)], 16, _hoisted_1$5)), [[_directive_ripple]]);
  }), 128))], 16);
}
...
var script = {
  ...
  methods: {
    ...
    sortMultiple: function sortMultiple(value) {
      ...
      var data10 = _toConsumableArray(value);
      data10.sort(function(data1, data222) {
        return _this5.multisortField(data1, data222, 0);
      });
      return data10;
    },
...
function usePrimeDataTable() {
  const tableData = ref([]);
  const filters = ref({});
  const dataTableRef = ref();
  function exportCSV2() {
    var _a;
    (_a = dataTableRef.value) == null ? void 0 : _a.exportCSV();
  }
  return {
    tableData,
    filters,
    dataTableRef,
    exportCSV: exportCSV2
  };
}
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const { tableData, filters, dataTableRef, exportCSV: exportCSV2 } = usePrimeDataTable();
    filters.value = {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_IconField = script$l$1;
      const _component_InputIcon = script$k$1;
      const _component_InputText = script$M;
      const _component_Column = script$s;
      const _component_Button = script$H;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "card" }, _attrs))}><h2>DataTable Example</h2>`);
      _push(ssrRenderComponent(_component_DataTable, {
        ref_key: "dataTableRef",
        ref: dataTableRef,
        filters: unref(filters),
        "onUpdate:filters": ($event) => isRef(filters) ? filters.value = $event : null,
        value: unref(tableData),
        "data-key": "name",
        ...
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="datatable-header"${_scopeId}><div class="flex justify-between"${_scopeId}><span class="text-xl"${_scopeId}>Products</span>`);
            _push2(ssrRenderComponent(_component_IconField, { "icon-position": "left" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_InputIcon, { class: "pi pi-search" }, null, _parent3, _scopeId2));
            ...
            return [
              createVNode("div", { class: "datatable-header" }, [
                createVNode("div", { class: "flex justify-between" }, [
                  createVNode("span", { class: "text-xl" }, "Products"),
                  createVNode(_component_IconField, { "icon-position": "left" }, {
                    default: withCtx(() => [
                      createVNode(_component_InputIcon, { class: "pi pi-search" }),
                      createVNode(_component_InputText, {
                        modelValue: unref(filters).global.value,
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex justify-between"${_scopeId}><span class="text-2xl"${_scopeId}>${ssrInterpolate(unref(tableData) ? unref(tableData).length : 0)} Products</span>`);
            _push2(ssrRenderComponent(_component_Button, {
              icon: "pi pi-external-link",
              label: "Export",
              onClick: unref(exportCSV2)
            }, null, _parent2, _scopeId));
            _push2(`</div>`);
          } else {
            return [
              createVNode("div", { class: "flex justify-between" }, [
                createVNode("span", { class: "text-2xl" }, toDisplayString(unref(tableData) ? unref(tableData).length : 0) + " Products", 1),
        ...
        paginatorRight: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) ;
          else {
            return [];
          }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/prime/datatable.vue");
