import { L as useRuntimeConfig, Z as withLeadingSlash, P as joinURL, S as withoutTrailingSlash, X as withBase, Y as useRequestEvent } from './server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-B7PiAqPb.mjs').then((m) => m.useContentDatabase());
